document.addEventListener("DOMContentLoaded", () => {
    ...
    const answers = {
      en: {
        ...
        "android development": "Throughout my journey, I also have started to the basics of developing Android applications using Java and working with APIs in Android Studio."
      },
      pt: {
